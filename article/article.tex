...
to the bibliography like this: \cite{Cd94} just typing.}}
...
For boxing equation \verb|\boxed{}| has to be used.
...
The next equation represents the area of a circle. It will have an equation number and a label so it can be referenced anywhere in the document.
